...
// Due to deprecation: https://developer.android.com/reference/android/inputmethodservice/KeyboardView
// Copied from: https://android.googlesource.com/platform/frameworks/base/+/0ebfffb8976d291b49b83410b821d60f5aa8c4aa
// Adjusted according to: https://github.com/hijamoya/KeyboardView/tree/master
...
import com.roalyr.new7rowkb.Keyboard.Key;
 ...
 * @attr ref R.styleable#KeyboardView_keyBackgroundModifier
...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        // Retrieve attributes efficiently and handle potential null values
        ...
        previewLayout = a.getResourceId(R.styleable.KeyboardView_keyPreviewLayout, 0);
        ...
        if (mKeyBackground != null) {
            ...
            // Handle case where mKeyBackground is null, e.g., set default padding
            mPadding = new Rect(0, 0, 0, 0); // This line is now redundant
        }

        if (mKeyBackgroundModifier != null) {
            mKeyBackgroundModifier.getPadding(mPadding);
        } else {
            // Handle case where mKeyBackgroundModifier is null, e.g., set default padding
            mPadding = new Rect(0, 0, 0, 0); // This line is now redundant
        }
        ...
        try {
            ...
            if (previewLayout != 0) {
                ...
                if (mPreviewText != null) {
                    ...
                    // Handle the case where mPreviewText is null
                    mShowPreview = false; // For example, disable preview
                }
            ...
            Log.e("KeyboardView", "Error in constructor", e);
    ...
    private void onBufferDraw() {
        ...
        final Drawable keyBackgroundModifier = mKeyBackgroundModifier;
